...
dimers. The NCIA D1200 dataset contains 1200 different dimers. The NCIA D442x10 dataset
contains 442 10-point dissociation curves, each covering a range from 0.8 to 2.0 times the
equilibrium intermolecular separation.
