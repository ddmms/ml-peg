...
from mlipaudit.benchmarks.sampling.sampling import SamplingBenchmark


class MlPegSamplingBenchmark(SamplingBenchmark):
    """
    ``SamplingBenchmark`` wired up for ml-peg's ASE calculators.
