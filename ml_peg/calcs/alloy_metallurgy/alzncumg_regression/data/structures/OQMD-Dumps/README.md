# OQMD Structure Subset

This directory stages the first Al-Cu-Mg-Zn metallurgy regression slice copied from evalpot's OQMD dump cache.
...
Included first-slice structures:
