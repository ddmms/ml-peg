"""
Compute the NCIA D1200 dataset for London dispersion.

Phys. Chem. Chem. Phys., 2022,24, 14780-14793.
"""
...
class NCIAD1200Benchmark(zntrack.Node):
    """Benchmark the NCIA_D1200 dataset."""
    ...
    def run(self):
        ...
        data_path = (
            download_s3_data(
                filename="NCIA_D1200.zip",
                key="inputs/non_covalent_interactions/NCIA_D1200/NCIA_D1200.zip",
            )
            / "NCIA_D1200"
        )
