"""
Compute the NCIA HB300SPXx100.

Journal of Chemical Theory and Computation 2020 16 (10), 6305-6316.
"""
...
def test_ncia_hb300spxx10(mlip: tuple[str, Any]) -> None:
    """
    Run NCIA HB300SPXx10 barriers benchmark.
    ...
    data_path = (
        download_s3_data(
            filename="NCIA_HB300SPXx10.zip",
            key="inputs/non_covalent_interactions/NCIA_HB300SPXx10/NCIA_HB300SPXx10.zip",
        )
        / "NCIA_HB300SPXx10"
    )
