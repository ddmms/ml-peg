...
from ml_peg.analysis.aqueous_solutions.bulk_water import aml
from ml_peg.analysis.aqueous_solutions.bulk_water.decorators import (
    cell_to_bar,
)
...
DATA_PATH = (
    download_s3_data(
        ...
        key="inputs/aqueous_solutions/bulk_water/bulk_water.zip",
    )
    / "bulk_water"
)
...
def test_bulk_water(
    ...
    """
    Run bulk water tests.

    Parameters
    ----------
    metrics
        All bulk water metrics.
