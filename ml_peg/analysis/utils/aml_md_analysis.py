"""
Shared MD analysis primitives (RDFs, VDOS, VACFs) for aqueous/interface benchmarks.

Adapted from the AML analysis code; upon usage cite Schran et al, PNAS, 2021.
"""
