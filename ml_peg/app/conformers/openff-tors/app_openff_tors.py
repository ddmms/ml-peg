...
DATA_PATH = APP_ROOT / "data" / "conformers" / "openff-tors"
...
class OpenFFTorsApp(BaseApp):
    ...
    def register_callbacks(self) -> None:
        ...
        scatter = read_plot(
            DATA_PATH / "figure_openff-tors.json",
        ...
        if model_dir.exists():
            ...
            structs = [
                f"assets/conformers/openff-tors/{MODELS[0]}/{label}.xyz"
                for label in labels
            ]
        else:
            structs = []
...
def get_app() -> OpenFFTorsApp:
    ...
    return OpenFFTorsApp(
        ...
        docs_url=DOCS_URL,
        table_path=DATA_PATH / "openff-tors_metrics_table.json",
        extra_components=[
