...
class MPCONF196App(BaseApp):
    """MPCONF196 benchmark app layout and callbacks."""

    def register_callbacks(self) -> None:
        """Register callbacks to app."""
        scatter = read_plot(
            DATA_PATH / "figure_mpconf196.json",
...
def get_app() -> MPCONF196App:
    """
    Get MPCONF196 benchmark app layout and callback registration.
    ...
    return MPCONF196App(
        ...
        description=(
            ...
            "196 biomolecule fragments. "
            "Reference data from CCSD(T) calculations."
        ),
        docs_url=DOCS_URL,
        table_path=DATA_PATH / "mpconf196_metrics_table.json",
        extra_components=[
