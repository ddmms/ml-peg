...
def build_settings_panel() -> Details:
    ...
    expand-all-benchmarks preference and the Hard Reset button (Behaviour).
        ...
        [
            ...
            Div(
                [
                    ...
                    Div(
                        # Label kept in step with main (#777 renamed it from
                        # "Clear cache"); moving the button in here must not
                        # quietly undo that.
                        Button(
                            "Hard Reset",
                            ...
                            title=(
                                ...
                                "Display preferences above are kept."
                            ),
